...
using Adventure.BuildingBlocks.Persistence.EFCore.AdventureWorks.Entities;
using Microsoft.EntityFrameworkCore;

namespace Adventure.BuildingBlocks.Persistence.EFCore.AdventureWorks.DBContext;
...
public partial class AdventureWorksDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<SalesOrderDetail>(entity =>
        {
            ...
            entity.HasOne(d => d.SpecialOfferProduct).WithMany(p => p.SalesOrderDetail)
